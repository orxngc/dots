...
" + C" "Calculator" \
" + SHIFT + W" "Search websites" \
" + A" "Open notifications" \
" + SHIFT + A" "Clear notifications" \
" + W" "Launch Firefox" \
" + ." "Emoji picker" \
" + S" "Take screenshot" \
" + SHIFT + M" "Mute microphone" \
" + D" "Launch Discord" \
" + P" "Pause player" \
" + SHIFT + P" "Next track" \
...
" + E" "File browser" \
" + L" "Lock screen" \
" + BACKSLASH" "Open power menu" \
" + APOSTRAPHE" "Change wallpaper" \
" + V" "Open clipboard" \
