        ...
        ''
          /* >>> ALL MODULES <<< */
            * {
            ...
            else ''border-radius: 15px 0px 0px 15px; margin: 4px 0px 4px 2px;''
          }
            ...
            if boxyStyle == true
            then ''border-radius: 0px; margin: 0px;''
            else ''border-radius: 0px 15px 15px 0px; margin: 4px 2px 4px 0px;''
          }
            ...
            if boxyStyle == true
            then ''border-radius: 0px; margin: 0px;''
            else ''border-radius: 15px; margin: 4px;''
          }
            padding: 2px 10px;
            }
