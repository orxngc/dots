...
echo "---------"
echo "Some features coming soon: "
echo "1. Switching to a pretty SDDM thing instead of tuigreet."
echo "2. A thing that displays all the keybinds."
echo "3. Properly implement Android virtualization (it's extremely buggy right now.)"
echo "---------"
